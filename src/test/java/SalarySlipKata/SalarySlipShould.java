...
public class SalarySlipShould {
  ...
  display_a_simple_salary_slip_for_an_employee_receiving_just_base_salary() {
    ...
    SalarySlip salarySlip = new SalarySlip(console);
    salarySlip.addBaseSalaryFor(EMPLOYEE_ID_12345, new GBP(2000.00), parse("2016-09-01"));

    salarySlip.printSalaryFor(EMPLOYEE_ID_12345);
